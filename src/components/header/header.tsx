...
export default function Header({ text, locale }: HeaderProps) {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-5 md:px-20 py-5 transition-all duration-300 bg-gradient-to-b from-black via-black/80 to-transparent">
      <a href="/" className="">
